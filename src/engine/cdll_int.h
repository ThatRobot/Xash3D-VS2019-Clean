...
typedef int HSPR;	// handle to a graphic
...
typedef struct cl_enginefuncs_s
{
	...
	int	(*pfnSPR_Frames)( HSPR hPic );
	int	(*pfnSPR_Height)( HSPR hPic, int frame );
	int	(*pfnSPR_Width)( HSPR hPic, int frame );
	void	(*pfnSPR_Set)( HSPR hPic, int r, int g, int b );
	...
	void	(*pfnSetCrosshair)( HSPR hspr, wrect_t rc, int r, int g, int b );
	...
	const struct model_s* (*GetSpritePointer)( HSPR hSprite );
