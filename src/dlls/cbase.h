...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	void		FirePhysBullet(ULONG	cShots, Vector  vecSrc, Vector	vecDirShooting, Vector	vecSpread, float flDistance, int iBulletType, int iTracerFreq = 4, int iDamage = 0, entvars_t* pevAttacker = NULL);
